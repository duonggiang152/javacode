...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        setSize(1000,900);
        LaiXeView lxv = new LaiXeView();
        TuyenView tv = new TuyenView();
        initComponents();
        jTabbedPane1.addTab("lai xe", lxv);
        jTabbedPane1.addTab("tuyen", tv);
        PhanCongView pcv = new PhanCongView();
        jTabbedPane1.addTab("Phan Cong", pcv);
    }
